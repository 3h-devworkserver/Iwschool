			...
			<div class="box">
				<div class="box-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-12 col-md-12">
							{!! Form::text('identifier', (isset($pages))  ? $pages->identifier : '' ,['class' => 'form-control'] ) !!}
						</div>
					</div>
					<div class="form-group">
...
<!-- start of sidebar -->
		<div class="col-md-3 col-sm-3 right-sidebar">
			...
			<div class="box box-default">
				<div class="box-header with-border">
					<h3 class="box-title">
						<?php if($pages->featured_image != ''){ echo 'Change'; }else { echo 'Upload';} ?> Featured Image
						<!-- {!! Form::label('file','Upload Featured Image',array('class'=>'control-lable')) !!} -->
					</h3>
					<div class="box-tools pull-right">
						<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-angle-up"></i></button>
				...
				<div class="box-body upload-block">
						...
						@else
						<div class="bg-img <?php if($pages->featured_image != ''){ echo 'featured-img'; } ?>"></div>
						@endif
						<span class="btn btn-primary btn-file btn-sm">
						<i class="fa fa-folder-open"></i><?php if($pages->featured_image != ''){ echo 'Change'; }else { echo 'Upload';} ?> Image
