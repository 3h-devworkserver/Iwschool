<head>
    ...
    <title> IWSchool - @yield('htmlheader_title', 'Your title here') </title>
    ...
    <link href="{{ asset('vendor/nestable/nestable.css') }}" rel="stylesheet" type="text/css" />

    <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
          page. However, you can choose any other skin. Make sure you
          apply the skin class to the body tag so the changes take effect.
    -->
    <link href="{{ asset('/css/skins/skin-orange.css') }}" rel="stylesheet" type="text/css" />
    <!-- iCheck -->
