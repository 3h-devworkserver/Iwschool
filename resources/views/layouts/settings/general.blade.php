...
{!! Form::text('sitename', (isset($generals) && count($generals) > 0)  ? $generals->site_name : '' ,['class' => 'form-control'] ) !!}
</div>
</div>
<div class="form-group">
{!! Form::label('description','Tagline',array('class'=>'col-sm-12 control-lable')) !!}
<div class="col-sm-12">
{!! Form::text('description',(isset($generals) && count($generals) > 0)  ? $generals->tagline : '',['class' => 'form-control'] ) !!}
</div>
</div>
<div class="form-group">
{!! Form::label('email','Admin Email',array('class'=>'col-sm-12 control-lable')) !!}
<div class="col-sm-12">
{!! Form::email('admin_email',(isset($generals) && count($generals) > 0)  ? $generals->admin_email : '',['class' => 'form-control'] ) !!}
</div>
</div>
...
<div class="col-sm-12">
{!! Form::text('mapaddress',(isset($generals) && count($generals) > 0)  ? $generals->map_address : '',['class' => 'form-control'] ) !!}
</div>
</div>
<div class="form-group">
{!! Form::label('map_lat','Map Latitude',array('class'=>'col-sm-12 control-lable')) !!}
<div class="col-sm-12">
{!! Form::text('map_lat',(isset($generals) && count($generals) > 0)  ? $generals->map_lat : '',['class' => 'form-control'] ) !!}
</div>
</div>
<div class="form-group">
{!! Form::label('map_lon','Map longitude',array('class'=>'col-sm-12 control-lable')) !!}
<div class="col-sm-12">
{!! Form::text('map_lon',(isset($generals) && count($generals) > 0)  ? $generals->map_lon : '',['class' => 'form-control'] ) !!}
</div>
</div>
